...
public class RegisterPage {
	...
	public boolean userRegister(String FirstName, String LastName, String EMail, String Telephone, String Password,
		...
		String successMsg = eleUtil.waitForElementVisible(SuccessMessage, constant.DEFAULT_ELEMENT_TIME_OUT).getText();

		System.out.println(successMsg);
		if (successMsg.contains(constant.REGISTER_SUCCESSFUL_MESSAGE)) {
